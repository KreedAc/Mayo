  ...
  return (
    <html lang="it">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Bungee&family=Bungee+Shade&family=Archivo:ital,wght@0,400;0,700;1,400&family=Permanent+Marker&family=Space+Mono:wght@400;700&family=Anton&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
